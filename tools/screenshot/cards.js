...
const CARDS = [
  { title: 'Hardening — SSH · ufw · fail2ban · swap', file: 'card-hardening.txt', out: 'lx-card-hardening.png' },
  { title: 'Backup restore — verified in throwaway sandbox', file: 'restore.txt', out: 'lx-card-restore.png' },
  { title: 'Audit & fix — PHP-FPM pool (before / after)', file: 'phpfpm.txt', out: 'lx-card-phpfpm.png' },
  { title: 'Zero-downtime migration — blue → green', file: 'migration.txt', out: 'lx-card-migration.png' },
];
